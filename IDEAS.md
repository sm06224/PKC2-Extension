...
- [00-spec-revisions.md](./ideas/00-spec-revisions.md) — SR-1 〜 SR-15
  - SR-1: `message_id` 必須化
...
### A. Debugging / Inspection ([詳細](./ideas/A-debugging.md))
...
### B. Record Input ([詳細](./ideas/B-record-input.md))
...
### C. Record Output ([詳細](./ideas/C-record-output.md))
...
### D. Multi-PKC / Bridge ([詳細](./ideas/D-multi-pkc.md))
...
### E. 専門ユース ([詳細](./ideas/E-specialized.md))
...
### F. オフライン添付ビューア / リッチエディタ (新規) ([詳細](./ideas/F-file-viewers.md))
...
6. **C1 export-downloader** — embedded export 検証
