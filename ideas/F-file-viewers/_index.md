...
| F11 | [premium-markdown-viewer](F11-premium-markdown-viewer.md) | text/md | **Tier 2** ★ |

> **F11 はライブラリを bundle しない**(エンジン借用)。ホストの PKC-Markdown コアを
> `render-request`/`render-result`(**SR-18** / PKC2 #849)経由で借り、base.css も `stylesheet`
> で貸与される。複製の 3 負債(drift / asset / CSS)を構造的に回避する最初の実証ツール。
